...
third, then add that result and the fourth, and so on until all numbers in the
list have been used once.
...
**magnitude** of the final sum. The magnitude of a pair is 3 times the
