...
be either **on** or **off**; at the start of the reboot process, they are all
...
or **off** by following a list of **reboot steps** (your puzzle input). Each
step specifies a cuboid (the set of all cubes that have coordinates which fall
...
that overlaps partially with some cubes that are on, ultimately turning off 8
cubes:
...
Your puzzle answer was `1285677377848549`.
